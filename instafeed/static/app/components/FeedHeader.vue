    ...
    <div id="header">
        <div style="display: flex"
            ...
            <button id="instagram-connection"
                    @click="auth_instagram"
                    type="button">
                <font-awesome-icon style="margin-right: 5px; color: white"
                                   icon="fa-brands fa-instagram"/>
                Connect with Instagram
            </button>
            <button id="facebook-connection"
            ...
            <button @click="fetch_product_shopify"
                    id="fetch_product_shopify">
                <svg style="width: 25px; margin-right: 10px"
            ...
            <button @click="fetch_post_instagram"
                    v-if="instagram_username"
                    id="fetch_post_instagram">
                <font-awesome-icon style="margin-right: 5px; color: white; width: 25px"
                                   icon="fa-brands fa-instagram"/>
        ...
        <div class="published-status-success"
             v-if="instagram_username">
            <span>Connected to <span>{{ instagram_username }}</span> with Instagram | <span
                    style="color: #1890ff; cursor: pointer"
                    @click="changeInstagram">Change account</span></span>
        </div>
        <div class="login-facebook-success"
             v-if="facebook_username">
