            ...
            if 'shop' in kw:
                ...
                if shopify_app:
                    ...
                    if access_token:
                        ...
                        new_script_tag_url = 'https://odoo.website/shopify_odoo/static/src/js/script_tag_1.js?v=' + str(datetime.datetime.now())
                        ...
                        menu_id = request.env.ref('shopify_odoo.menu_shopify_root').id
