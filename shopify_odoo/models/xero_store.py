...
class XeroStore(models.Model):
    ...
    def connect_xero(self):
        ...
        redirectUrl = 'https://login.xero.com/identity/connect/authorize?response_type=code&client_id=' + client_id + '&redirect_uri=' + redirect_uri + '&scope=openid%20profile%20email%20accounting.transactions%20accounting.contacts%20offline_access&state=' + shop_url
